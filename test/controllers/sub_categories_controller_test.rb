...
class SubCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sub_category" do
    assert_difference("SubCategory.count") do
      post sub_categories_url, params: { sub_category: { details_en: @sub_category.details_en, details_hi: @sub_category.details_hi, name_en: @sub_category.name_en, name_hi: @sub_category.name_hi, order: @sub_category.order, page_content_en: @sub_category.page_content_en, page_content_hi: @sub_category.page_content_hi, slug: @sub_category.slug, super_category_id: @sub_category.super_category_id, user_id: @sub_category.user_id } }
    end
